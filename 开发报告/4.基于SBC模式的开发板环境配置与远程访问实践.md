# 基于 SBC 模式的 Arduino UNO Q 开发环境优化与远程访问
...
![UNO Q SBC 模式启动画面](pictures456/4/01_sbc_mode_boot_screen.png)
...
![安装 fastfetch](pictures456/4/02_install_fastfetch.png)
...
![fastfetch 显示系统信息](pictures456/4/03_fastfetch_system_info.png)
...
![迁移 apt 缓存和 Docker 数据](pictures456/4/04_move_apt_cache_and_docker_data.png)
...
![验证存储优化结果](pictures456/4/05_verify_storage_optimization.png)
...
![终端中的中文显示问题](pictures456/4/06_terminal_chinese_rendering_issue.png)
...
![安装并启用 xrdp](pictures456/4/07_install_and_enable_xrdp.png)
...
![配置 xrdp 会话并获取开发板 IP](pictures456/4/08_configure_xrdp_session_and_get_ip.png)
...
![xrdp 登录界面](pictures456/4/09_xrdp_login_screen.png)

登录成功后，就可以直接在 Windows 桌面中看到 UNO Q 的 Debian 图形界面，并继续打开终端、App Lab 等工具进行操作：

![xrdp 远程桌面连接效果](pictures456/4/10_xrdp_remote_desktop_effect.png)
...
![通过 scp 回传报告截图](pictures456/4/11_copy_report_images_from_board.png)
...
本篇报告延续了整个项目的资料体系，下面整理出与 Arduino UNO Q、Arduino App Lab、SBC 模式和远程开发环境相关的附件清单，便于后续统一查阅：
...
| 开发板初始化与更新 | [Connect, Configure, and Update boards in Arduino App Lab](https://docs.arduino.cc/software/app-lab/configure/config/) |
| UNO Q SSH 连接说明 | [Connect to UNO Q via Secure Shell](https://docs.arduino.cc/tutorials/uno-q/ssh/) |
| Arduino App CLI 文档 | [Arduino App CLI](https://docs.arduino.cc/software/app-lab/tutorials/cli/) |
| UNO Q 引脚图 | [ABX00162-full-pinout.pdf](https://docs.arduino.cc/resources/pinouts/ABX00162-full-pinout.pdf) |
| UNO Q 数据手册 | [ABX00162-ABX00173-datasheet.pdf](https://docs.arduino.cc/resources/datasheets/ABX00162-ABX00173-datasheet.pdf) |
| UNO Q 原理图 | [ABX00162-schematics.pdf](https://docs.arduino.cc/resources/schematics/ABX00162-schematics.pdf) |
| UNO Q CAD 文件 | [ABX00162-cad-files.zip](https://docs.arduino.cc/static/e05d1a3141208468509d10c329387dcd/ABX00162-cad-files.zip) |
| UNO Q 3D 模型 | [ABX00162-step.zip](https://docs.arduino.cc/resources/models/ABX00162-step.zip) |
